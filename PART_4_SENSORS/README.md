...
three writers share, the query techniques, six runnable dashboards, and the argument for
...
| 18 | [Dashboard Archetypes](./18_dashboard-archetypes.md) | Six complete query blocks, and the order to build them |
